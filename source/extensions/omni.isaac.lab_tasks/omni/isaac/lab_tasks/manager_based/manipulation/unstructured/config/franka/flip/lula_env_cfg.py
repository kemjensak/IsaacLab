...
from omni.isaac.lab.controllers.config.rmp_flow import FRANKA_RMPFLOW_CFG  # isort: skip

@configclass
class FrankaFlipObjectEnvCfg(joint_pos_env_cfg.FrankaFlipObjectEnvCfg):
    def __post_init__(self):
        ...
        FRANKA_PANDA_HIGH_PD_CFG.actuators["panda_shoulder"].velocity_limit = 2.175/1000
        FRANKA_PANDA_HIGH_PD_CFG.actuators["panda_forearm"].velocity_limit = 2.61/1000
