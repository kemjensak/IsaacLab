...
@configclass
class ShelfReachingSceneCfg(InteractiveSceneCfg):
...
@configclass
class ShelfReachingEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the lifting environment."""

    # Scene settings
    scene: ShelfReachingSceneCfg = ShelfReachingSceneCfg(num_envs=4096, env_spacing=2.5)
    # Basic settings
