...
if TYPE_CHECKING:
    ...
    from .commands_cfg import GraspPoseInFlipCommandCfg


class GraspPoseInFlipCommand(CommandTerm):
    ...
    cfg: GraspPoseInFlipCommandCfg
    """Configuration for the command term."""

    def __init__(self, cfg: GraspPoseInFlipCommandCfg, env: ManagerBasedRLEnv):
