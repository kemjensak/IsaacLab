...
from omni.isaac.orbit.utils.math import subtract_frame_transforms, quat_mul, transform_points
from omni.isaac.orbit.sensors import FrameTransformerData
from omni.isaac.orbit.managers import ObservationTermCfg as ObsTrem
...
class book_flip_point_in_robot_root_frame(ManagerTermBase):
    ...
    def __init__(self, cfg: ObsTrem, env: RLTaskEnv):
